...
SensorTag.discover(function(tag) {
    ...
    tag.enableIrTemperature(enableLUXReading);
    }


    function enableLUXReading() {		// attempt to enable the IR Temperature sensor
        console.log('enableIRTemperatureSensor');
        // when you enable the IR Temperature sensor, start notifications:
    ...
    function notifyMe() {
        ...
        //tag.notifyLux(listenForTempReading);   	// start the accelerometer listener
